...
class Photo(object):
    ...
    __readonly = ['id', 'farm', 'secret', 'server', 'isfavorite', 'license', 'rotation', 
    ...
    def __init__(self, id, owner=None, dateuploaded=None, \
                 ...
                 isfavorite=None, farm=None, server=None, license=None, rotation=None):
...
def _parse_photo(photo):
    ...
    secret = photo.secret
    server = photo.server
    p = Photo(photo.id, farm=farm, owner=owner, title=title, ispublic=ispublic,\
